...
import ModalBasedAlerts from '../example/ModalExample/ModalBasedAlerts';
...
const DomainsManager: React.FC = () => {
    const { domainsData, isLoading, fetchProjectsDomains, deleteProjectsDomains, verifyProjectsDomains } = useProjectsDomains();
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <div className="flex-1 border border-gray-300 dark:border-gray-800 rounded-lg p-4">
                            ...
                            <Badge
                                children="Geralmente dentro de 30min"
                                color='dark'
