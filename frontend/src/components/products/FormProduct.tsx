          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex justify-center">
              <div className="flex items-center justify-center">
                <label className="flex flex-col items-center justify-center cursor-pointer text-center dark:text-white text-sm">
                  <input type="file"
                    accept="image/*"
                    {...register("image")}
                    required
                  />
                  {errors.image && (
                    <p className=" mt-2 text-red-500 text-xs mt-1">{errors.image.message}</p>
                  )}
                  <div className=" mt-2 bg-brand-500/20 text-brand-500 rounded-full px-6 py-3 w-52 text-sm font-medium hover:bg-brand-500/30 transition-colors">
                    Escolher imagem
                  </div>
                </label>
              </div>
