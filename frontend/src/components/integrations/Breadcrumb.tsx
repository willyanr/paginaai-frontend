...
export const Breadcrumb = ({ }) => {
    ...
    return (
        <div className="w-full">
            <div className='border border-gray-300 w-full p-6 rounded-lg dark:bg-gray-800 mb-5 dark:border-gray-600'>
                <nav className="flex" aria-label="Breadcrumb">
                    <ol className="inline-flex items-center ">
                        <li className="inline-flex items-center">
                            <button
                                onClick={() => stateActivePages('tracker')} 
                              className={`inline-flex items-center text-base font-medium text-white py-2 px-5 rounded-full whitespace-nowrap dark:text-white ${activePageTracker ? 'bg-brand-500' : ''}`}
                            >
                                <svg className="w-5 h-5 text-white mr-2" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <button
                                 ...
                                 className={`inline-flex items-center text-base font-medium text-white py-2 px-5 rounded-full whitespace-nowrap dark:text-white hover:bg-brand-500 cursor-pointer ${activePageMonitoring ? 'bg-brand-500' : ''}`}> Monitoramento
                                </button>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div className="flex items-center">
                                ...
                                <a href="javascript:;" className="text-base font-medium text-gray-900 py-2 px-5 rounded-full hover:bg-brand-500 hover:text-white whitespace-nowrap dark-text-white dark:text-white">IA (Inteligência Artificial) <span className="py-1 px-2 bg-brand-500 text-white text-xs rounded-full ml-3 group-hover:bg-white">Em Breve</span></a>
                            </div>
                        </li>
                    </ol>
                </nav>
