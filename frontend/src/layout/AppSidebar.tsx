...
const AppSidebar: React.FC = () => {
      ...
      {navItems.map((nav, index) => (
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            >
              <span
                className={`text-black  ${openSubmenu?.type === menuType && openSubmenu?.index === index
            ...
            nav.path && (
              ...
              >
                <span
                  className={`text-black${isActive(nav.path)
                      ? "menu-item-icon-active"
                      : "menu-item-icon-inactive"
                    }`}
                >
  ...
  return (
    ...
    >
      <div
        className={`py-8 flex hidden lg:block  ${!isExpanded && !isHovered ? "lg:justify-center" : "justify-start"
          }`}
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
